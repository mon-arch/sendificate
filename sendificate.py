...
def Main_Application():
        ...
        def convert_pptx_to_pdf(input_file_path, output_folder_path):
            ...
            powerpoint.Quit()
            print_to_console(f"Conversion completed. PDF saved at: {pdf_file}")
        ...
        def send_email_with_pdf_and_message(pdf_file, recipient_email, sender_email, sender_password, subject, message_content):
